        ...
        <div>
            <div className='w-9/12 mx-auto relative'>
                ...
                <section className='bg-[#F4F3F0] p-20 my-12'>
                    <h1 className="text-3xl md:text-4xl text-center text-rancho mb-4">Add New Coffee</h1>
                    ...
                    <form className='my-8 text-raleway w-full' onSubmit={handleFormSubmit}>
                        ...
                        <button type="submit" className='btn-outline w-full flex items-center gap-2 justify-center mt-4'>Add Coffee <FaCoffee /></button>
                    </form>
                </section>
            </div>

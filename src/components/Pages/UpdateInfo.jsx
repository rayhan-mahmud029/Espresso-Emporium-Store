        ...
        fetch(`http://localhost:5000/coffee/${_id}`, {
            ...
            .then(data => {
                ...
                if (data.modifiedCount > 0) {
                    Swal.fire({
                        title: 'Success!',
                        text: 'Coffee data updated successfully',
                        icon: 'success',
                    ...
                    <form className='my-8 text-raleway w-full' onSubmit={handleFormSubmit}>
                        <div className="mb-6 flex gap-4">
                            <div className='flex-1'>
                                ...
                                <input defaultValue={name} type="text" name="name" id="name" placeholder='Enter coffee name' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                            <div className='flex-1'>
                                <label htmlFor="chef" className='block text-md font-semibold mb-3 text-gray-900 dark:text-white '>Chef</label>
                                <input defaultValue={chef} type="text" name="chef" id="chef" placeholder='Enter chef name' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                        </div>
                        ...
                        <div className="mb-6 flex gap-4">
                            <div className='flex-1'>
                                ...
                                <input defaultValue={supplier} type="text" name="supplier" id="supplier" placeholder='Enter coffee supplier' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                            <div className='flex-1'>
                                <label htmlFor="taste" className='block text-md font-semibold mb-3 text-gray-900 dark:text-white '>Taste</label>
                                <input defaultValue={taste} type="text" name="taste" id="taste" placeholder='Enter coffee taste' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                        </div>
                        ...
                        <div className="mb-6 flex gap-4">
                            <div className='flex-1'>
                                ...
                                <input defaultValue={category} type="text" name="category" id="category" placeholder='Enter coffee category' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                            <div className='flex-1'>
                                <label htmlFor="details" className='block text-md font-semibold mb-3 text-gray-900 dark:text-white '>Details</label>
                                <input defaultValue={details} type="text" name="details" id="details" placeholder='Enter coffee details' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                        </div>
                        ...
                        <div className="mb-6 flex gap-4">
                            <div className='flex-1'>
                                ...
                                <input defaultValue={photo} type="url" name="photo" id="photo" placeholder='Enter photo URL' className='p-3 bg-white rounded-sm w-full' />
                            </div>
                        </div>
